...
let currentMultaId = null, importData = [], charts = {}, supabase = null;
function initSupabase() { supabase = window.supabase.createClient(SUPABASE_URL, SUPABASE_KEY); }

const DB = {
    async getVehicles() { const { data } = await supabase.from('vehicles').select('*').order('created_at', { ascending: false }); return data || []; },
    async addVehicle(d) { const { data, error } = await supabase.from('vehicles').insert(d).select().single(); if (error) throw new Error(error.message); return data; },
    async updateVehicle(id, d) { const { data, error } = await supabase.from('vehicles').update(d).eq('id', id).select().single(); if (error) throw new Error(error.message); return data; },
    async deleteVehicle(id) { const { error } = await supabase.from('vehicles').delete().eq('id', id); if (error) throw new Error(error.message); },
    async getVehicleByPlaca(p) { const { data } = await supabase.from('vehicles').select('*').ilike('placa', p).maybeSingle(); return data; },
    async getVehicleById(id) { const { data } = await supabase.from('vehicles').select('*').eq('id', id).single(); return data; },
    async getFines() { const { data } = await supabase.from('fines').select('*').order('created_at', { ascending: false }); return data || []; },
    async addFine(d) { const { data, error } = await supabase.from('fines').insert(d).select().single(); if (error) throw new Error(error.message); return data; },
    async updateFine(id, d) { const { data, error } = await supabase.from('fines').update(d).eq('id', id).select().single(); if (error) throw new Error(error.message); return data; },
    async deleteFine(id) { const { error } = await supabase.from('fines').delete().eq('id', id); if (error) throw new Error(error.message); },
    async getFineByAIT(a) { const { data } = await supabase.from('fines').select('*').eq('numero_ait', a).maybeSingle(); return data; },
    async getFineById(id) { const { data } = await supabase.from('fines').select('*').eq('id', id).single(); return data; },
    async getFinesByPlaca(p) { const { data } = await supabase.from('fines').select('*').ilike('placa', p); return data || []; },
    async getCondutores() { const { data } = await supabase.from('condutores').select('*').order('nome'); return data || []; },
    async addCondutor(d) { const { data, error } = await supabase.from('condutores').insert(d).select().single(); if (error) throw new Error(error.message); return data; },
    async updateCondutor(id, d) { const { data, error } = await supabase.from('condutores').update(d).eq('id', id).select().single(); if (error) throw new Error(error.message); return data; },
    async deleteCondutor(id) { const { error } = await supabase.from('condutores').delete().eq('id', id); if (error) throw new Error(error.message); },
    async getCondutorById(id) { const { data } = await supabase.from('condutores').select('*').eq('id', id).single(); return data; },
    async getAudiencias() { const { data } = await supabase.from('audiencias').select('*').order('data', { ascending: true }); return data || []; },
    async addAudiencia(d) { const { data, error } = await supabase.from('audiencias').insert(d).select().single(); if (error) throw new Error(error.message); return data; },
    async updateAudiencia(id, d) { const { data, error } = await supabase.from('audiencias').update(d).eq('id', id).select().single(); if (error) throw new Error(error.message); return data; },
    async deleteAudiencia(id) { const { error } = await supabase.from('audiencias').delete().eq('id', id); if (error) throw new Error(error.message); },
    async getAudienciaById(id) { const { data } = await supabase.from('audiencias').select('*').eq('id', id).single(); return data; },
    async getSettings() { const { data } = await supabase.from('settings').select('*').eq('id', 1).maybeSingle(); return data || { dias_alerta: [10, 5, 3], emails: [] }; },
    async saveSettings(d) { const { error } = await supabase.from('settings').upsert({ id: 1, ...d, updated_at: new Date().toISOString() }); if (error) throw new Error(error.message); },
    async getImportLogs() { const { data } = await supabase.from('import_logs').select('*').order('data', { ascending: false }); return data || []; },
    async addImportLog(d) { const { error } = await supabase.from('import_logs').insert(d); if (error) throw new Error(error.message); },
    async getHistorico(multaId) { const { data } = await supabase.from('historico').select('*').eq('multa_id', multaId).order('created_at', { ascending: false }); return data || []; },
    async getAnexos(multaId) { const { data } = await supabase.from('anexos').select('*').eq('multa_id', multaId).order('created_at', { ascending: false }); return data || []; },
    async addAnexo(d) { const { data, error } = await supabase.from('anexos').insert(d).select().single(); if (error) throw new Error(error.message); return data; },
    async deleteAnexo(id) { const { error } = await supabase.from('anexos').delete().eq('id', id); if (error) throw new Error(error.message); }
};
